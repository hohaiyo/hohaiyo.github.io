			...
			$.ajax({
				...
				success:function(data){
			        ...
			        $.each(data.data.list,function(i){
			            ...
			            var the_title = result_two[i].title;
			            var the_status = result_two[i].status;
			            var the_price = result_two[i].price.toLocaleString();
			            var the_typeName = result_two[i].typeName;
			            var the_id = result_two[i].id;
					 ...
					 //    var oldTime_two = new Date(oldTime);
						...
						// the_time = the_year + "/" + the_month + "/" + the_day; //把时间按照20xx/x/x的形式拼起来
						// // 往html中添加内容
				  //       var the_obj = '<div class="find_demand_content_left_box_item">\
						...
						// 			<img src="img/project-logo.png" class="local_img">\
						// 		</a>\
						// 	</div>\
						// 	<div class="pull-left find_demand_item_div">\
						// 		<p class="find_demand_item_p">\
						// 			<span class="find_demand_content_left_box_item_num pull-left">'+the_title+'</span>\
						// 			<a href="project_details.html" class="find_demand_item_status_green pull-left">'+the_status+'</a>\
						// 			<span class="find_demand_item_price pull-right">\
						// 				<span>¥</span><span class="get_price">'+the_price+'</span><span>元</span>\
						// 			</span>\
						// 		</p>\
						// 		<p class="find_demand_item_p_two">\
						// 			<span>\
						// 				<span class="color_gray">项目类型:</span>\
						// 				<span>'+the_typeName+'</span>\
						// 			</span>\
						// 			<span>\
						...
						// 		</p>\
						// 		<p>\
						// 			<span class="color_gray creationTime">'+the_time+'</span><span class="color_gray">丨</span>\
						// 			<span class="color_gray">已有<span class="has_bid">'+0+'</span>人投标</span>\
						// 		</p>\
						// 	</div>\
						// </div>';
							...
							success:function(data){
								...
								<div class="find_demand_content_left_box_item_img pull-left hidden-xs">\
									...
									<div class="pull-left find_demand_item_div">\
										...
										<p>\
											<span class="color_gray creationTime">'+the_time+'</span><span class="color_gray">丨</span>\
											<span class="color_gray">已有<span class="has_bid">'+data.data+'</span>人投标</span>\
										</p>\
									</div>\
								</div>';
								$('.zxf_pagediv').before(the_obj);//在分页器前面添加	
						...
						function local_data(n){
							box_item[n].onmouseenter = function(){
								...
								localStorage.setItem("demand_data",string_result);							
							};
						};
